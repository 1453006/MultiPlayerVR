...
namespace DaydreamElements.ArmModels {
  ...
  public class VisualizeArmModel : Photon.MonoBehaviour{
 ...
 #region Photon
        Vector3 correctShoulderPos;
        Vector3 correctElbowPos;
        Vector3 correctWristPos;
        Quaternion correctShoulderRotation;
        Quaternion correctElbowRotation;
        Quaternion correctWristRotation;
    ...
    void OnEnable() {
            ...
            //else
            //{
            //    GvrControllerInput.OnPostControllerInputUpdated += OnPostClientControllerUpdated;
            //    OnPostClientControllerUpdated();
    ...
    private void OnPostControllerUpdated() {
      ...
      if (laser != null) {
        ...
        //datld
        private void OnPostClientControllerUpdated()
        {
            Vector3 shoulderPos;
            Vector3 elbowPos;
            Vector3 wristPos;
            ...
            {
                shoulderPos = correctShoulderPos;
                elbowPos = correctElbowPos;
                wristPos = correctWristPos;
                shoulderRotation = correctShoulderRotation;
